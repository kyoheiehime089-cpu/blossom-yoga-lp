(()=>{
  ...
  function loginUrl(member){return 'https://kyoheiehime089-cpu.github.io/blossom-yoga-lp/friends-serufu-member-booking-app-game-lab/?'+new URLSearchParams({mid:member.member_code,pin:member.pin}).toString()}
