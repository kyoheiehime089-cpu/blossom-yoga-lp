(()=>{
  ...
  function ensureBookingFamilyFields(){
    ...
    const name1=$('#familyName1');
    const name2=$('#familyName2');
    if(!isFamily()){
    ...
    if(name1){name1.innerHTML=optionList(names,true);name1.required=true;}
    if(name2){name2.innerHTML=optionList(names,true);name2.required=false;}
  }
  ...
  window.FSFamilyUsers={readNames,writeNames,ensureBookingFamilyFields,key};
})();